            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card1">
                        ...
                        <button> <Link style={{textDecoration:"none"}} to="/details/sport" >Subscribe</Link> </button>
                    </div>
                    <div class="card1">
                        <img src="cars1.jpg" alt=""/>
                        <h1>Cars Normal </h1>
                        <p>From iconic Normal brands to timeless classics</p>
                        <button><Link style={{textDecoration:"none"}} to="/details/normal" >Subscribe</Link></button>
                    </div>
                    <div class="card1">
                        <img src="cars2.jpg" alt=""/>
                        <h1>Cars Luxaury </h1>
                        <p>From iconic luxaury brands to timeless classics</p>
                        <button><Link style={{textDecoration:"none"}} to="/details/luxury" >Subscribe</Link></button>
                    </div>
                    <div class="card1">
                        <img src="cars3.jpg" alt=""/>
                        <h1>Cars Classic </h1>
                        <p>From iconic Classic brands to timeless classics</p>
                        <button><Link style={{textDecoration:"none"}} to="/details/classic" >Subscribe</Link></button>
                    </div>
                </div>
            </div>
